resource "aws_security_group" "web_sg" {
  ...
  vpc_id      = "vpc-07e3d60b0c1f6f6e6"  #change vpc id
...
resource "aws_autoscaling_group" "example_asg" {
  ...
  #change subnet ids
  vpc_zone_identifier = ["subnet-08c98d103ae85e43b", "subnet-062164aa169b88fb9"]   # Subnets to use for the load balancer
...
resource "aws_lb" "my_lb" {
  ...
  subnets            = ["subnet-08c98d103ae85e43b", "subnet-062164aa169b88fb9"]  # Subnets to use for the load balancer
